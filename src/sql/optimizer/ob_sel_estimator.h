...
public:
  ...
  virtual int merge(ObSelEstimator &other, ObSelEstimator* &discard_estimator);
...
public:
  ...
  virtual int merge(ObSelEstimator &other, ObSelEstimator* &discard_estimator) override {
    int ret = OB_SUCCESS;
